        ...
        const movieDetail = `
            <div class="bg-white shadow-lg rounded-lg p-6">
                ...
                <div class="flex flex-col md:flex-row">
                    ...
                    <img src="${selectedMovie.image}" alt="${selectedMovie.title}" class="w-full md:w-1/3 rounded-lg mb-4 md:mb-0">

                    <!-- Movie Details Section (Right) -->
                    <div class="md:ml-6 w-full md:w-2/3 flex flex-col">
                        
                        <!-- Title Row -->
                        <h1 class="text-4xl font-bold mb-4">${selectedMovie.title}</h1>
                        
                        <!-- First Row: Category, Cast, Director, Producer -->
                        <div class="flex flex-col md:flex-row w-full">
                            <div class="md:w-1/2 mb-4 md:mb-0">
                                <p class="text-lg mb-2"><strong>Category: </strong> ${selectedMovie.category}</p>
                                <p class="text-lg mb-2 break-words"><strong>Cast: </strong> ${selectedMovie.cast}</p>
                                <p class="text-lg mb-2"><strong>Director: </strong> ${selectedMovie.director}</p>
                                <p class="text-lg mb-2"><strong>Producer: </strong> ${selectedMovie.producer}</p>
                            </div>


                            <!-- Synopsis and Rating -->
                            <div class="md:w-1/2 md:ml-6">
                                <p class="text-lg mb-2 break-words"><strong>Synopsis: </strong> ${selectedMovie.synopsis}</p>
                                <p class="text-lg mb-4"><strong>Rating: </strong> ${selectedMovie.rating}</p>
                            </div>
                        </div>
                        ...
                        <div class="mt-6 text-center">
                            <button class="bg-blue-600 text-white py-2 px-4 rounded-lg text-lg">Book Now</button>
                        </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (document.getElementById('movie-details-container')) {
        ...
        // Otherwise, render movies on the homepage
        loadMovies();
    }
});